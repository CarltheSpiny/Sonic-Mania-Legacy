...
public class MCreatorGreenHillFlower2 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:greenhillflower2")
	public static final Block block = null;

	public MCreatorGreenHillFlower2(Elementssonic_mania instance) {
		super(instance, 159);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("greenhillflower2");
		}
