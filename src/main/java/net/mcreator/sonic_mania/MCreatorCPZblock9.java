...
public class MCreatorCPZblock9 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:cpzdeco_tube2")
	public static final Block block = null;

	public MCreatorCPZblock9(Elementssonic_mania instance) {
		super(instance, 22);
	}
