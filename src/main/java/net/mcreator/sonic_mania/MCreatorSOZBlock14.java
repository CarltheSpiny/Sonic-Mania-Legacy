...
public class MCreatorSOZBlock14 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sozblock14")
	public static final Block block = null;

	public MCreatorSOZBlock14(Elementssonic_mania instance) {
		super(instance, 39);
	}
