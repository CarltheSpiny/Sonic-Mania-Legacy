...
public class MCreatorSOZblock8 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sozblock8")
	public static final Block block = null;

	public MCreatorSOZblock8(Elementssonic_mania instance) {
		super(instance, 34);
	}
