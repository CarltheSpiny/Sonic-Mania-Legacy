...
public class MCreatorOOZblock extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:oozblock")
	public static final Block block = null;

	public MCreatorOOZblock(Elementssonic_mania instance) {
		super(instance, 128);
	}
