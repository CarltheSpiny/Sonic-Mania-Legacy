...
public class MCreatorSOZBlock17 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sozblock17")
	public static final Block block = null;

	public MCreatorSOZBlock17(Elementssonic_mania instance) {
		super(instance, 37);
	}
