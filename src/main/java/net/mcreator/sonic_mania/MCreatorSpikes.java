...
public class MCreatorSpikes extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:spikes")
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ANVIL).sound(SoundType.METAL).hardnessAndResistance(2f, 10f).lightValue(0).harvestLevel(1)
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Block block = this;
			{
				...
				MCreatorSpikesEntityWalksOnTheBlock.executeProcedure($_dependencies);
			}
		}
	}
}
