...
public class MCreatorGreenHillFlower1 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:greenhillflower1")
	public static final Block block = null;

	public MCreatorGreenHillFlower1(Elementssonic_mania instance) {
		super(instance, 162);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("greenhillflower1");
		}
