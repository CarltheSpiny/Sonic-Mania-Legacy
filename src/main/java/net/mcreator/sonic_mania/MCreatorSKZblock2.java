...
public class MCreatorSKZblock2 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:skzblock2")
	public static final Block block = null;

	public MCreatorSKZblock2(Elementssonic_mania instance) {
		super(instance, 151);
	}
