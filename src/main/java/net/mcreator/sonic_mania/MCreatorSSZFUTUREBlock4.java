...
public class MCreatorSSZFUTUREBlock4 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sszfutureblock4")
	public static final Block block = null;

	public MCreatorSSZFUTUREBlock4(Elementssonic_mania instance) {
		super(instance, 89);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sszfutureblock4");
		}
