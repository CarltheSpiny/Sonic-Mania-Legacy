...
public class MCreatorGHZtiki1 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:ghztiki1")
	public static final Block block = null;

	public MCreatorGHZtiki1(Elementssonic_mania instance) {
		super(instance, 6);
	}
