...
public class MCreatorOOZblock5 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:oozblock5")
	public static final Block block = null;

	public MCreatorOOZblock5(Elementssonic_mania instance) {
		super(instance, 299);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Block block = this;
			{
				...
				MCreatorOOZblock5EntityWalksOnTheBlock.executeProcedure($_dependencies);
			}
		}
	}
}
