...
public class MCreatorMirageSaloonAct1knux extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:miragesaloonact1knux")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("miragesaloonact1knux");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				MCreatorMirageSaloonAct1knuxRightClicked.executeProcedure($_dependencies);
			}
			return ar;
		}
