...
public class MCreatorSKZblock10 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:skzblock10")
	public static final Block block = null;

	public MCreatorSKZblock10(Elementssonic_mania instance) {
		super(instance, 159);
	}
