...
public class MCreatorPGZblock1 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:pgzblock1")
	public static final Block block = null;

	public MCreatorPGZblock1(Elementssonic_mania instance) {
		super(instance, 57);
	}
