...
public class MCreatorSKZblock5 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:skzblock5")
	public static final Block block = null;

	public MCreatorSKZblock5(Elementssonic_mania instance) {
		super(instance, 144);
	}
