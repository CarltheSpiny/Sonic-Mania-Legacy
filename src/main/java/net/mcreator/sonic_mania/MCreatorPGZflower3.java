...
public class MCreatorPGZflower3 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:pgzflower3")
	public static final Block block = null;

	public MCreatorPGZflower3(Elementssonic_mania instance) {
		super(instance, 180);
	}
