...
public class MCreatorPGZleaves3 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:pgzleaves3")
	public static final Block block = null;

	public MCreatorPGZleaves3(Elementssonic_mania instance) {
		super(instance, 69);
	}
