...
public class MCreatorSKZblock12 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:skzblock12")
	public static final Block block = null;

	public MCreatorSKZblock12(Elementssonic_mania instance) {
		super(instance, 151);
	}
