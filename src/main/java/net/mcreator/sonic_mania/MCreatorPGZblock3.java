...
public class MCreatorPGZblock3 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:pgzblock3")
	public static final Block block = null;

	public MCreatorPGZblock3(Elementssonic_mania instance) {
		super(instance, 64);
	}
