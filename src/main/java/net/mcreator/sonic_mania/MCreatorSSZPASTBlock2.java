...
public class MCreatorSSZPASTBlock2 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sszpastblock2")
	public static final Block block = null;

	public MCreatorSSZPASTBlock2(Elementssonic_mania instance) {
		super(instance, 77);
	}
