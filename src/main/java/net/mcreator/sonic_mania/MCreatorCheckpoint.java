...
public class MCreatorCheckpoint extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:checkpoint")
	...
	public static class CustomBlock extends Block {
		...
		public void animateTick(BlockState state, World world, BlockPos pos, Random random) {
			...
			if (true)
				for (int l = 0; l < 4; ++l) {
					...
					world.addParticle(ParticleTypes.END_ROD, d0 - 0.27, d1 + 0.22, d2, 0, 0, 0);
				}
		}
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				MCreatorCheckpointOnBlockRightClicked.executeProcedure($_dependencies);
			}
			return true;
		}
	}
