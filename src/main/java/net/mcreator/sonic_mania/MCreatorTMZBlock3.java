...
public class MCreatorTMZBlock3 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:tmzblock3")
	public static final Block block = null;

	public MCreatorTMZBlock3(Elementssonic_mania instance) {
		super(instance, 149);
	}
