...
public class MCreatorMSZblock extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mszblock")
	public static final Block block = null;

	public MCreatorMSZblock(Elementssonic_mania instance) {
		super(instance, 93);
	}
