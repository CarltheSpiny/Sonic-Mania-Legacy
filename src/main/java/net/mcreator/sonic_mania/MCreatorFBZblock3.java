...
public class MCreatorFBZblock3 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:fbzblock3")
	public static final Block block = null;

	public MCreatorFBZblock3(Elementssonic_mania instance) {
		super(instance, 47);
	}
