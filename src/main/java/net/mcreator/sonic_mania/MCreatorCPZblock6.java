...
public class MCreatorCPZblock6 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:cpzblock5")
	public static final Block block = null;

	public MCreatorCPZblock6(Elementssonic_mania instance) {
		super(instance, 16);
	}
