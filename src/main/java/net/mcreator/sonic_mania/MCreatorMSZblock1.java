...
public class MCreatorMSZblock1 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mszblock1")
	public static final Block block = null;

	public MCreatorMSZblock1(Elementssonic_mania instance) {
		super(instance, 96);
	}
