...
public class MCreatorPGZBlock extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:pgzblock")
	public static final Block block = null;

	public MCreatorPGZBlock(Elementssonic_mania instance) {
		super(instance, 49);
	}
