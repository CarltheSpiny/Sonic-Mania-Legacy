...
public class MCreatorPGZpillar4 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:pgzpillar4")
	public static final Block block = null;

	public MCreatorPGZpillar4(Elementssonic_mania instance) {
		super(instance, 51);
	}
