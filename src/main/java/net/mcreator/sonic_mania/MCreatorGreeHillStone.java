...
public class MCreatorGreeHillStone extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:ghzblock3")
	public static final Block block = null;

	public MCreatorGreeHillStone(Elementssonic_mania instance) {
		super(instance, 3);
	}
