...
public class MCreatorPGZpillar3 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:pgzpillar3")
	public static final Block block = null;

	public MCreatorPGZpillar3(Elementssonic_mania instance) {
		super(instance, 54);
	}
