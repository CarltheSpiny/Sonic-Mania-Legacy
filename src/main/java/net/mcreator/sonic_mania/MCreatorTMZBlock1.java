...
public class MCreatorTMZBlock1 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:tmzblock1")
	public static final Block block = null;

	public MCreatorTMZBlock1(Elementssonic_mania instance) {
		super(instance, 147);
	}
