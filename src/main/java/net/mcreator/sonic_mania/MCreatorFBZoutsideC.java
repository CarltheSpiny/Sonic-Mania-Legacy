...
public class MCreatorFBZoutsideC extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:fbzoutsidec")
	public static final Block block = null;

	public MCreatorFBZoutsideC(Elementssonic_mania instance) {
		super(instance, 55);
	}
