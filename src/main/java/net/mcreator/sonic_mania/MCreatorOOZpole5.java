...
public class MCreatorOOZpole5 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:oozpole5")
	public static final Block block = null;

	public MCreatorOOZpole5(Elementssonic_mania instance) {
		super(instance, 298);
	}
