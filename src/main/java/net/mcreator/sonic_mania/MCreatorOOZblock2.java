...
public class MCreatorOOZblock2 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:oozblock2")
	public static final Block block = null;

	public MCreatorOOZblock2(Elementssonic_mania instance) {
		super(instance, 127);
	}
