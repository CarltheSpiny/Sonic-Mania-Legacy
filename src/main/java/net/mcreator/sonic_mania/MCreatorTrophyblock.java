...
public class MCreatorTrophyblock extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:trophyblock")
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorTrophyblock.block, (int) (3)));
		}
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				MCreatorTrophyblockOnBlockRightClicked.executeProcedure($_dependencies);
			}
			return true;
		}
	}
