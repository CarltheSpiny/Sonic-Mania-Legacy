...
public class MCreatorSSZPASTBricks extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sszpastbricks")
	public static final Block block = null;

	public MCreatorSSZPASTBricks(Elementssonic_mania instance) {
		super(instance, 300);
	}
