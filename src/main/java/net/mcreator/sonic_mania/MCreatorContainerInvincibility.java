...
public class MCreatorContainerInvincibility extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:containerinvincibility")
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("containerinvincibility");
		}
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Block block = this;
			{
				...
				MCreatorContainerInvincibilityEntityWalksOnTheBlock.executeProcedure($_dependencies);
			}
		}
	}
}
