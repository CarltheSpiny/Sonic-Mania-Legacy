...
public class MCreatorPGZblock2 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:pgzblock2")
	public static final Block block = null;

	public MCreatorPGZblock2(Elementssonic_mania instance) {
		super(instance, 58);
	}
