...
public class MCreatorSOZBlock13 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sozblock13")
	public static final Block block = null;

	public MCreatorSOZBlock13(Elementssonic_mania instance) {
		super(instance, 32);
	}
