...
public class MCreatorSOZblock11 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sozblock11")
	public static final Block block = null;

	public MCreatorSOZblock11(Elementssonic_mania instance) {
		super(instance, 35);
	}
