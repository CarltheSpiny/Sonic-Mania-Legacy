...
public class MCreatorContainerSpeed extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:containerspeed")
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("containerspeed");
		}
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Block block = this;
			{
				...
				MCreatorContainerSpeedEntityWalksOnTheBlock.executeProcedure($_dependencies);
			}
		}
	}
}
