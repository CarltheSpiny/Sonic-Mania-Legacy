...
public class MCreatorFBZblock8 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:fbzblock8")
	public static final Block block = null;

	public MCreatorFBZblock8(Elementssonic_mania instance) {
		super(instance, 46);
	}
