...
public class MCreatorCPZblock12 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:cpzblock8")
	public static final Block block = null;

	public MCreatorCPZblock12(Elementssonic_mania instance) {
		super(instance, 17);
	}
