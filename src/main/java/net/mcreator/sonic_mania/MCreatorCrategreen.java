...
public class MCreatorCrategreen extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:crategreen")
	public static final Block block = null;

	public MCreatorCrategreen(Elementssonic_mania instance) {
		super(instance, 57);
	}
