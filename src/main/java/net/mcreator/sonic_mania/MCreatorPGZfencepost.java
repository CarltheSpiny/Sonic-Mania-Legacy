...
public class MCreatorPGZfencepost extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:pgzfencepost")
	public static final Block block = null;

	public MCreatorPGZfencepost(Elementssonic_mania instance) {
		super(instance, 82);
	}
