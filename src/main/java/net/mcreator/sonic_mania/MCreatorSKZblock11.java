...
public class MCreatorSKZblock11 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:skzblock11")
	public static final Block block = null;

	public MCreatorSKZblock11(Elementssonic_mania instance) {
		super(instance, 150);
	}
