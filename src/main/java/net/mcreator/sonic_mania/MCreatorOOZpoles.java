...
public class MCreatorOOZpoles extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:oozpoles")
	public static final Block block = null;

	public MCreatorOOZpoles(Elementssonic_mania instance) {
		super(instance, 124);
	}
