...
public class MCreatorContainerRing extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:containerring")
	...
	public static class CustomBlock extends FallingBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorRing.block, (int) (10)));
		}
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Block block = this;
			{
				...
				MCreatorContainerRingEntityWalksOnTheBlock.executeProcedure($_dependencies);
			}
		}
	}
}
