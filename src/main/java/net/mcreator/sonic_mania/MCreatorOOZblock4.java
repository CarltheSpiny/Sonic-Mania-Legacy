...
public class MCreatorOOZblock4 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:oozblock4")
	public static final Block block = null;

	public MCreatorOOZblock4(Elementssonic_mania instance) {
		super(instance, 121);
	}
