...
public class MCreatorCPZBlock14 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:cpzblock14")
	public static final Block block = null;

	public MCreatorCPZBlock14(Elementssonic_mania instance) {
		super(instance, 13);
	}
