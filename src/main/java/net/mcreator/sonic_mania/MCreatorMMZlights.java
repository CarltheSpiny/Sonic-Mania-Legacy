...
public class MCreatorMMZlights extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mmzlights")
	public static final Block block = null;

	public MCreatorMMZlights(Elementssonic_mania instance) {
		super(instance, 138);
	}
