...
public class MCreatorTMZBlock2 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:tmzblock2")
	public static final Block block = null;

	public MCreatorTMZBlock2(Elementssonic_mania instance) {
		super(instance, 137);
	}
