...
public class MCreatorOOZpole4 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:oozpole4")
	public static final Block block = null;

	public MCreatorOOZpole4(Elementssonic_mania instance) {
		super(instance, 125);
	}
