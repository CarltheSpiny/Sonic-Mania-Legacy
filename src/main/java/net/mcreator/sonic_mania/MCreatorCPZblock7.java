...
public class MCreatorCPZblock7 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:cpzblock6")
	public static final Block block = null;

	public MCreatorCPZblock7(Elementssonic_mania instance) {
		super(instance, 15);
	}
