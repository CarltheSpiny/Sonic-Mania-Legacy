...
public class MCreatorMSZblock2 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mszblock2")
	public static final Block block = null;

	public MCreatorMSZblock2(Elementssonic_mania instance) {
		super(instance, 99);
	}
