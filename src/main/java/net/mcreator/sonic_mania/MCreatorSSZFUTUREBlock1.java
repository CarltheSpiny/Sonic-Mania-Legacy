...
public class MCreatorSSZFUTUREBlock1 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sszfutureblock1")
	public static final Block block = null;

	public MCreatorSSZFUTUREBlock1(Elementssonic_mania instance) {
		super(instance, 87);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sszfutureblock1");
		}
