...
public class MCreatorMMZblock extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mmzblock")
	public static final Block block = null;

	public MCreatorMMZblock(Elementssonic_mania instance) {
		super(instance, 141);
	}
