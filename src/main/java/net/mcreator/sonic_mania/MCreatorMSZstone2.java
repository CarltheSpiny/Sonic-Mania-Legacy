...
public class MCreatorMSZstone2 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mszstone2")
	public static final Block block = null;

	public MCreatorMSZstone2(Elementssonic_mania instance) {
		super(instance, 106);
	}
