...
public class MCreatorMMZlights2 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mmzlights2")
	public static final Block block = null;

	public MCreatorMMZlights2(Elementssonic_mania instance) {
		super(instance, 139);
	}
