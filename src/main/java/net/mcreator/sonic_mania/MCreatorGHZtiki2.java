...
public class MCreatorGHZtiki2 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:ghztiki2")
	public static final Block block = null;

	public MCreatorGHZtiki2(Elementssonic_mania instance) {
		super(instance, 7);
	}
