...
public class MCreatorMMZgold extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mmzgold")
	public static final Block block = null;

	public MCreatorMMZgold(Elementssonic_mania instance) {
		super(instance, 133);
	}
