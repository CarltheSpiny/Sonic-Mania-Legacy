...
public class MCreatorXCrate2 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:xcrate2")
	public static final Block block = null;

	public MCreatorXCrate2(Elementssonic_mania instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorRing.block, (int) (1)));
		}
	}
}
