...
public class MCreatorMSZpillar2body extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mszpillar2body")
	public static final Block block = null;

	public MCreatorMSZpillar2body(Elementssonic_mania instance) {
		super(instance, 108);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("mszpillar2body");
		}
