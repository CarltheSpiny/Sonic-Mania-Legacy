...
public class MCreatorSKZblock1 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:skzblock1")
	public static final Block block = null;

	public MCreatorSKZblock1(Elementssonic_mania instance) {
		super(instance, 140);
	}
