...
public class MCreatorSSZPASTFloor extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sszpastfloor")
	public static final Block block = null;

	public MCreatorSSZPASTFloor(Elementssonic_mania instance) {
		super(instance, 82);
	}
