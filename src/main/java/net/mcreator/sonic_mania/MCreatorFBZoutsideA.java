...
public class MCreatorFBZoutsideA extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:fbzoutsidea")
	public static final Block block = null;

	public MCreatorFBZoutsideA(Elementssonic_mania instance) {
		super(instance, 53);
	}
