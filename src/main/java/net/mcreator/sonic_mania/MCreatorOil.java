...
public class MCreatorOil extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:oil")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("sonic_mania:oil_bucket")
		...
		elements.blocks.add(() -> new FlowingFluidBlock(still, Block.Properties.create(Material.WATER)) {
			...
			public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
				...
				Block block = this;
				{
					...
					MCreatorOilMobplayerCollidesBlock.executeProcedure($_dependencies);
				}
			}
		}.setRegistryName("oil"));
