...
public class MCreatorSSZPASTBlock4 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sszpastblock4")
	public static final Block block = null;

	public MCreatorSSZPASTBlock4(Elementssonic_mania instance) {
		super(instance, 87);
	}
