...
public class MCreatorMSZBIRDBODY1 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mszbirdbody1")
	public static final Block block = null;

	public MCreatorMSZBIRDBODY1(Elementssonic_mania instance) {
		super(instance, 109);
	}
