...
public class MCreatorSOZBlock15 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sozblock15")
	public static final Block block = null;

	public MCreatorSOZBlock15(Elementssonic_mania instance) {
		super(instance, 31);
	}
