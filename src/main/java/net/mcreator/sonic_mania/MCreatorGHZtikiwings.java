...
public class MCreatorGHZtikiwings extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:ghztikiwings")
	public static final Block block = null;

	public MCreatorGHZtikiwings(Elementssonic_mania instance) {
		super(instance, 9);
	}
