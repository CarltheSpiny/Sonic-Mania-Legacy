...
public class MCreatorBridge extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:ghzddeco_bridge")
	public static final Block block = null;

	public MCreatorBridge(Elementssonic_mania instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ghzddeco_bridge");
		}
