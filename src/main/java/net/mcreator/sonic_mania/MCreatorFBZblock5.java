...
public class MCreatorFBZblock5 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:fbzblock5")
	public static final Block block = null;

	public MCreatorFBZblock5(Elementssonic_mania instance) {
		super(instance, 41);
	}
