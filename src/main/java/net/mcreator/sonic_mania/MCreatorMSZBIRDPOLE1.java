...
public class MCreatorMSZBIRDPOLE1 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mszbirdpole1")
	public static final Block block = null;

	public MCreatorMSZBIRDPOLE1(Elementssonic_mania instance) {
		super(instance, 112);
	}
