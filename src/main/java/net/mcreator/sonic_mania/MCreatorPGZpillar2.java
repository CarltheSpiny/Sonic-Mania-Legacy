...
public class MCreatorPGZpillar2 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:pgzpillar2")
	public static final Block block = null;

	public MCreatorPGZpillar2(Elementssonic_mania instance) {
		super(instance, 61);
	}
