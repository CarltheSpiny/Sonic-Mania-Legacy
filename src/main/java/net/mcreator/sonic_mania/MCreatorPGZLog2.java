...
public class MCreatorPGZLog2 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:pgzlog2")
	public static final Block block = null;

	public MCreatorPGZLog2(Elementssonic_mania instance) {
		super(instance, 80);
	}
