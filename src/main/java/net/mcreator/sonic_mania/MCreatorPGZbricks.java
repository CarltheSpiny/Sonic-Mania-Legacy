...
public class MCreatorPGZbricks extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:pgzbricks")
	public static final Block block = null;

	public MCreatorPGZbricks(Elementssonic_mania instance) {
		super(instance, 71);
	}
