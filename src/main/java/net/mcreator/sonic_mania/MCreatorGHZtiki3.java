...
public class MCreatorGHZtiki3 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:ghztiki3")
	public static final Block block = null;

	public MCreatorGHZtiki3(Elementssonic_mania instance) {
		super(instance, 8);
	}
