...
public class MCreatorSSZFUTUREBlock2 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sszfutureblock2")
	public static final Block block = null;

	public MCreatorSSZFUTUREBlock2(Elementssonic_mania instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sszfutureblock2");
		}
