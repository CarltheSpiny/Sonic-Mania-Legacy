...
public class MCreatorSOZblock5 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sozblock5")
	public static final Block block = null;

	public MCreatorSOZblock5(Elementssonic_mania instance) {
		super(instance, 27);
	}
