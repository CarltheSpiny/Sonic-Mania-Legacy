...
public class MCreatorMSZcactus extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mszcactus")
	public static final Block block = null;

	public MCreatorMSZcactus(Elementssonic_mania instance) {
		super(instance, 115);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorMSZfruit.block, (int) (3)));
		}
