...
public class MCreatorSKZblock8 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:skzblock8")
	public static final Block block = null;

	public MCreatorSKZblock8(Elementssonic_mania instance) {
		super(instance, 147);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(), Block.Properties.create(Material.ROCK).sound(SoundType.GROUND)
					.hardnessAndResistance(1f, 10f).lightValue(1).harvestLevel(1).harvestTool(ToolType.PICKAXE));
			setRegistryName("skzblock8");
		}
