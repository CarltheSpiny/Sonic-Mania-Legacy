...
public class MCreatorFBZblock7 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:fbzblock7")
	public static final Block block = null;

	public MCreatorFBZblock7(Elementssonic_mania instance) {
		super(instance, 43);
	}
