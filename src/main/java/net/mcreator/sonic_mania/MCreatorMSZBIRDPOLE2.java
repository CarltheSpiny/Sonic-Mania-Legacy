...
public class MCreatorMSZBIRDPOLE2 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mszbirdpole2")
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			switch ((Direction) state.get(FACING)) {
				...
				case UP :
					return VoxelShapes.create(0D, 1D, 0.5D, 1D, 0D, 1D);
				case DOWN :
					return VoxelShapes.create(0D, 0D, 0.5D, 1D, 1D, 0D);
			}
		}
