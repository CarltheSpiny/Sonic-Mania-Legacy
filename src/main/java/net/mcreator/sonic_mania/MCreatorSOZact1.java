...
public class MCreatorSOZact1 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sozact1")
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				MCreatorSOZact1RightClicked.executeProcedure($_dependencies);
			}
			return ar;
		}
