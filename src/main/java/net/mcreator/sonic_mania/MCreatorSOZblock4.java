...
public class MCreatorSOZblock4 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sozblock4")
	public static final Block block = null;

	public MCreatorSOZblock4(Elementssonic_mania instance) {
		super(instance, 26);
	}
