...
public class MCreatorFBZoutsideB extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:fbzoutsideb")
	public static final Block block = null;

	public MCreatorFBZoutsideB(Elementssonic_mania instance) {
		super(instance, 54);
	}
