...
public class MCreatorCPZblock11 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:cpzblock7")
	public static final Block block = null;

	public MCreatorCPZblock11(Elementssonic_mania instance) {
		super(instance, 18);
	}
