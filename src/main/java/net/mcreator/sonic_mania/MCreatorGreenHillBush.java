...
public class MCreatorGreenHillBush extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:greenhillbush")
	public static final Block block = null;

	public MCreatorGreenHillBush(Elementssonic_mania instance) {
		super(instance, 177);
	}
