...
public class MCreatorSSZFUTUREBlock3 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sszfutureblock3")
	public static final Block block = null;

	public MCreatorSSZFUTUREBlock3(Elementssonic_mania instance) {
		super(instance, 86);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sszfutureblock3");
		}
