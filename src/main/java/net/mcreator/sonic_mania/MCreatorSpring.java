...
public class MCreatorSpring extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:spring")
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			...
			Block block = this;
			{
				...
				MCreatorSpringEntityWalksOnTheBlock.executeProcedure($_dependencies);
			}
		}
