...
public class MCreatorSOZblock12 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sozblock12")
	public static final Block block = null;

	public MCreatorSOZblock12(Elementssonic_mania instance) {
		super(instance, 37);
	}
