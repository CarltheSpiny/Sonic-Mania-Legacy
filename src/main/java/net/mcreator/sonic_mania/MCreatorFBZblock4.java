...
public class MCreatorFBZblock4 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:fbzblock4")
	public static final Block block = null;

	public MCreatorFBZblock4(Elementssonic_mania instance) {
		super(instance, 48);
	}
