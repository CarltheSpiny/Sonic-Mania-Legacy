...
public class MCreatorPGZpillar1base extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:pgzpillar1base")
	public static final Block block = null;

	public MCreatorPGZpillar1base(Elementssonic_mania instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("pgzpillar1base");
		}
