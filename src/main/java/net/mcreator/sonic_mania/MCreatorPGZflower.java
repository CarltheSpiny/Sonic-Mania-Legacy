...
public class MCreatorPGZflower extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:pgzflower")
	public static final Block block = null;

	public MCreatorPGZflower(Elementssonic_mania instance) {
		super(instance, 165);
	}
