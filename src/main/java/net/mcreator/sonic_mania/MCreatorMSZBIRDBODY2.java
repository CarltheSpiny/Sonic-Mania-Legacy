...
public class MCreatorMSZBIRDBODY2 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mszbirdbody2")
	public static final Block block = null;

	public MCreatorMSZBIRDBODY2(Elementssonic_mania instance) {
		super(instance, 108);
	}
