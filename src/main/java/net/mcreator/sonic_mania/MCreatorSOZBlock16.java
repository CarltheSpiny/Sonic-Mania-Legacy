...
public class MCreatorSOZBlock16 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sozblock16")
	public static final Block block = null;

	public MCreatorSOZBlock16(Elementssonic_mania instance) {
		super(instance, 30);
	}
