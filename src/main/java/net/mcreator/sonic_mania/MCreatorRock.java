...
public class MCreatorRock extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:ghzblock4")
	public static final Block block = null;

	public MCreatorRock(Elementssonic_mania instance) {
		super(instance, 4);
	}
