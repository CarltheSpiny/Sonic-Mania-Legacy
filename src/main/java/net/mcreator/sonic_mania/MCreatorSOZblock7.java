...
public class MCreatorSOZblock7 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sozblock7")
	public static final Block block = null;

	public MCreatorSOZblock7(Elementssonic_mania instance) {
		super(instance, 44);
	}
