...
public class MCreatorOOZblock1 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:oozblock1")
	public static final Block block = null;

	public MCreatorOOZblock1(Elementssonic_mania instance) {
		super(instance, 117);
	}
