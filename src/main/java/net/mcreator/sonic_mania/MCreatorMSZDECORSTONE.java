...
public class MCreatorMSZDECORSTONE extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mszdecorstone")
	public static final Block block = null;

	public MCreatorMSZDECORSTONE(Elementssonic_mania instance) {
		super(instance, 99);
	}
