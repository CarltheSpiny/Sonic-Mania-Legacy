...
public class MCreatorMSZBIRDPOLE4 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mszbirdpole4")
	public static final Block block = null;

	public MCreatorMSZBIRDPOLE4(Elementssonic_mania instance) {
		super(instance, 115);
	}
