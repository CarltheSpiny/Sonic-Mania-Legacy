...
public class MCreatorPGZact2 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:pgzact2")
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				MCreatorPGZact2RightClicked.executeProcedure($_dependencies);
			}
			return ar;
		}
