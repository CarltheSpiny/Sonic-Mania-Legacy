...
public class MCreatorSOZblock10 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sozblock10")
	public static final Block block = null;

	public MCreatorSOZblock10(Elementssonic_mania instance) {
		super(instance, 25);
	}
