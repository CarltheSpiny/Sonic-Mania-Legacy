...
public class MCreatorSSZFUTUREFloor extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sszfuturefloor")
	public static final Block block = null;

	public MCreatorSSZFUTUREFloor(Elementssonic_mania instance) {
		super(instance, 91);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sszfuturefloor");
		}
