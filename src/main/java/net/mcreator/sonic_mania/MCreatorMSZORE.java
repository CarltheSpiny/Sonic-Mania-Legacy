...
public class MCreatorMSZORE extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mszore")
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorMSZOREDROP.block, (int) (2)));
		}
	}
}
