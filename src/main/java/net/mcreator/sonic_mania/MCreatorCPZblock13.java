...
public class MCreatorCPZblock13 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:cpzdeco_tube1")
	public static final Block block = null;

	public MCreatorCPZblock13(Elementssonic_mania instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.GLASS).sound(SoundType.GLASS).hardnessAndResistance(2f, 10f).lightValue(0).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("cpzdeco_tube1");
		}
