...
public class MCreatorSKZblock4 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:skzblock4")
	public static final Block block = null;

	public MCreatorSKZblock4(Elementssonic_mania instance) {
		super(instance, 143);
	}
