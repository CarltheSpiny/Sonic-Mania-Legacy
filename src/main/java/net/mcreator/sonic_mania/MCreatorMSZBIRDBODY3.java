...
public class MCreatorMSZBIRDBODY3 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:mszbirdbody3")
	public static final Block block = null;

	public MCreatorMSZBIRDBODY3(Elementssonic_mania instance) {
		super(instance, 109);
	}
