...
public class MCreatorSOZblock1 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sozblock1")
	public static final Block block = null;

	public MCreatorSOZblock1(Elementssonic_mania instance) {
		super(instance, 23);
	}
