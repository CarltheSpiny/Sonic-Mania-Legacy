...
public class MCreatorSSZPASTBlock1 extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sszpastblock1")
	public static final Block block = null;

	public MCreatorSSZPASTBlock1(Elementssonic_mania instance) {
		super(instance, 78);
	}
