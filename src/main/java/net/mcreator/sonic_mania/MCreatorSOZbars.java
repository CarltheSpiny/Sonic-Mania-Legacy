...
public class MCreatorSOZbars extends Elementssonic_mania.ModElement {
	@ObjectHolder("sonic_mania:sozbars")
	public static final Block block = null;

	public MCreatorSOZbars(Elementssonic_mania instance) {
		super(instance, 28);
	}
